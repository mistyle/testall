package com.example.demo.test.serializable.json;
...
import com.example.demo.test.serializable.Person;
...
//
    ...
    private static void excuteWithProtoBuf() throws IOException {
        ...
        Person person=init(); //Person里面属性要定 义  @Protobuf(fieldType = FieldType.STRING,order = 1)
...
/**
 * jackjson (spring用的这个) 时间 :  219ms
 * 阿里的fastjson 379ms
 * baidu 的 jProtoBuf   92ms
 * Hessian序列化：23ms : 总大小->50071  占的空间很大
 **/